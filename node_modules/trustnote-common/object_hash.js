...
// function saveConfToFile(confJson) {
// 	var fs = require('fs');
// 	cordovaWriteFile
// 	fs.writeFile('./aaa.json', JSON.stringify(confJson, null, '\t'), 'utf8', function(err) {
// 		if (err) {
// 			return;
// 		}
// 	});
...
function getUnitHashToSign(objUnit) {
	var jsonsrc = JSON.stringify(objUnit);
	console.log("xuejin jsonsrc:" + jsonsrc);
	...
	var jsondest = JSON.stringify(objNakedUnit);
	console.log("xuejin jsondest:" + jsondest);
	//saveConfToFile(json);
	// for(var i in objNakedUnit){
	// 	console.log("xuejin objNakedUnit["+i+"]:" + objNakedUnit.i);
	// }
	//var hash = crypto.createHash("sha256").update(getSourceString(objNakedUnit), "utf8").digest();
	//console.log("xuejin hash:" + JSON.stringify(hash));
