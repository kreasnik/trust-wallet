...
// 更改代码
	...
	self.gono = function (noWallet) {
		$timeout(function () {
			profileService.create({noWallet: noWallet}, function (result) {
				// if (err) {
				...
				// 	 }, 3000);*/
				// }
				console.log("WalletJniPort -- walletHome : " + result.pubkey.toString());
				//go.setSePubkey(result);
				//go.walletHome();
				self.haschoosen();
			});
		}, 100);
		// $timeout(function () {
		// 	console.log("WalletJniPort -- walletHome");
		// 	go.walletHome();
		// }, 8000);
