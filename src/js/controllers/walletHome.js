		...
		$timeout(function () {
			profileService.requestTouchid(function (err) {
				...
				function composeAndSend(to_address) {
					...
					console.log("xuejin: merkle_proof:" + merkle_proof);
					...
					self.reCallApiToWalletHome = function (account, is_change, address_index, text_to_sign, cb) {
						...
						// console.log("xuejin: coin:" + coin + ", path:" + path + ", text_to_sign:" + text_to_sign + ", signature:" + signature);
						console.log("WalletJniPort-- start sign");
						console.log("WalletJniPort-- text_to_sign : " + JSON.stringify(text_to_sign));
						var data = new Buffer(text_to_sign, "base64");
						console.log("WalletJniPort-- text_to_sign.data : " + data.toString("hex"));
						cordova.plugins.walletjniport.sign(
							"12345678",
							path,
							0,
							0,
							...
							function onSuccess(result) {
								...
								var data = Bitcore.encoding.Base58Check.decode(result.signhash);
								var signature = data.toString("base64");
								console.log("WalletJniPort--sign pubkey : " + pubkey + ", signature : " + signature);
								cb(signature);
							},
					...
					fc.sendMultiPayment(opts, function (err) {
						...
						console.log("xuejin: gettext:" + gettext('sending'));
						...
						console.log("xuejin: recipient_device_address:" + recipient_device_address);
